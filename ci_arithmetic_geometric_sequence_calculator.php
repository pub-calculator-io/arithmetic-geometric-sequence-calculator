...
Version: 1.0.0
Author: Arithmetic and Geometric Sequence Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Arithmetic and Geometric Sequence Calculator by www.calculator.io";

function display_calcio_ci_arithmetic_geometric_sequence_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_arithmetic_geometric_sequence_calculator', 'display_calcio_ci_arithmetic_geometric_sequence_calculator' );